...
#[test]
fn 引用はオペレータ位置にも書ける() {
    // シンボルを2引数に適用しようとして失敗し、静かに記号項になる
